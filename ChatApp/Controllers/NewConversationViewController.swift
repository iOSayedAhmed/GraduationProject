...
extension NewConversationViewController : UISearchBarDelegate {
    ...
    func filterUsers(with term: String){
        //update the UI : either show result or noresult label

        guard let currentUserEmail = UserDefaults.standard.value(forKey: "email") as? String,hasFetced else {
            return
        }
        ...
        let results: [SearchResult] = users.filter({
            ...
            return name.hasPrefix(term.lowercased())}).compactMap({
